 ...
 */
class Version20151221172918 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE countries (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, alpha2 VARCHAR(2) NOT NULL, alpha3 VARCHAR(3) NOT NULL, numCode INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_5D66EBAD5E237E06 (name), UNIQUE INDEX UNIQ_5D66EBADB762D672 (alpha2), UNIQUE INDEX UNIQ_5D66EBADC065E6E4 (alpha3), UNIQUE INDEX UNIQ_5D66EBAD8ACB87F2 (numCode), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
