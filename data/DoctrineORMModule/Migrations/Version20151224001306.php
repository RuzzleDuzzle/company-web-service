 ...
 */
class Version20151224001306 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE owners (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, tsAdd INT NOT NULL, tsMod INT DEFAULT NULL, companyId INT NOT NULL, UNIQUE INDEX UNIQ_427292FA2480E723 (companyId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
